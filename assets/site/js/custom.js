...
jQuery(function() {
    ...
    jQuery("#create-account-submit").click(function() {
        ...
        var CustTelephone= jQuery('#CustTelephone').val();
      ...
      */
        ...
        var dataString = 'CustFirstName=' + CustFirstName + '&CustLastName=' + CustLastName + '&CustTelephone=' +CustTelephone+ '&CustTown=' + CustTown + '&CustAdd1=' + CustAdd1 + '&CustPostcode=' + CustPostcode + '&CustEmail=' + CustEmail + '&CustPassword=' + CustPassword + '&RestId=' + RestId;

        if (CustFirstName == '' || CustLastName == '' || CustLastName == '' || CustTown == ''|| CustAdd1 == '' || CustEmail == '' || CustPassword == '' || confirmPassword == '')
        {
...
function checkrest() {
    jQuery.post(base_url + "home/checkrest", function (responseText) {
        if (responseText == 1) {
            jQuery('.marquee-text').text('Open Now!').css('color','green');
        } else {
            jQuery('.marquee-text').text('we are closed now! Open 17:30').css('color','red');
        }
    }, "html");
    setTimeout("checkrest()", 30000);
}
