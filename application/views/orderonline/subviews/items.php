    ...
    <div class="row" style="min-height: 600px; width: 100%; margin: 0px; padding: 0px; border: 1px solid #eee; ">
        <div class="col-sm-12" style="padding: 0px; margin-top: 15px">
            <div class="col-md-3 left-ctbg">
                ...
                <select id="tabs" class="cuisinesearch_responsive_menu cuisinesearch-select" data-toggle="tab" onchange="chckFunction(this)">
