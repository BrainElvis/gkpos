...
<script>
    function chckFunction(obj) {
        var divId = '#' + obj.value;
        window.location.href = window.location.pathname + divId;
    ...
    jQuery(document).ready(function () {
        jQuery("#cboxCloseAlt").click(function () {
         ...
         jQuery("#cboxCloseAlt1").click(function () {
            jQuery.colorbox.close();
            return false;
        });
    });
    ...
    {
        jQuery(".entering_postcode_root_link").colorbox({
            inline: true,
            slideshow: false,
            scrolling: false,
            height: "auto",
                ...
                <?php if (true == $api_status): ?>
                    ...
                    <div class="card">
                        <ul class="nav nav-tabs" role="tablist">
                           ...
                           <div class="showcart_menuscroll pull-right">
                            <span id="cartButton">Cart</span>
                        </div>
                        <!--Tab panes -->
    ...
    <div id="postcode_popup_area" class="popupouter">
        <div class="popupshow">
            <div class="seperate_div">
                <div class="popup_heading">Your Area<a class="pull-right btn addtocart-btn" id="cboxCloseAlt1" >X</a></div>
                    ...
                    <div class="popupspan_100">
                        ...
                        <div class="popupspan_100">
                            <select class="choose_zone_home_small popup_input" id="your_area" name="your_area" >
                                <option>Select your town/city</option>
                                <?php if (!empty($cities)) : ?>
                                    <?php foreach ($cities AS $obj) : ?>
                                        <option value="<?php echo $obj->CityId; ?>"><?php echo $obj->CityName; ?></option>
                                    <?php endforeach; ?>
                                <?php endif ?>
                            </select>
                        </div>
...
<script>
    jQuery(document).ready(function() {
        $("#cartButton").click(function() {
            $('html, body').animate({
                scrollTop: $("#scolling-content-cart").offset().top
            }, 2000);
        });
        scrolling_cart();
    });
