                                ...
                                <table class="payment-table" width="100%" cellspacing="0" cellpadding="0" border="0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="odd">
                                            ...
                                            <td class="bdr-bottom" width="60%">
                                                <input readonly="readonly" value="<?php isset($cust_info1->CustTelephone) ? print $cust_info1->CustTelephone : print $cust_info1->CustMobile ?>" id="customers_telephone" name="customers_telephone" class="textfield cl_op_field" type="text">
                                            </td>
                                        </tr>
                                        <tr class="even">
            ...
            function(response) {
                if (response) {
                   ...
                   /*
                    ...
                    jQuery('#customers_telephone').val(address.CustPhone);
