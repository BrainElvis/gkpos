<form method="POST" action="https://secure.nochex.com/" name="nochex" id="nochex"> 
...
<div style="height:320px"><img src="<?php echo ASSETS_SITE_IMAGE_PATH . 'ajax-loader.gif' ?>"/></div>