...
$pickup_address .= (isset($rest_info ['City']) && $rest_info ['City']!='')?  get_city_name($rest_info ['City']):'';
$pickup_address .= (isset($rest_info['AreaId']) && $rest_info['AreaId']!='')?get_area_name($rest_info['AreaId']):'' ;
...
$delivery_address .= (isset($customer_order['OrderAddTown']) && $customer_order['OrderAddTown']!='')?  get_city_name($customer_order['OrderAddTown']).' ':'';
$delivery_address .= (isset($customer_order['OrderAddArea']) && $customer_order['OrderAddArea']!='')?  get_area_name($customer_order['OrderAddArea']):'';
            ...
            <div class="content-innerspan2">
                <div class="innercommon-right">
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="payment-table">
                        ...
                        <tr class="even">
                            <td width="80%" align="right" class="bdr-bottom bdr-right text-right" colspan="3"><?php echo $this->lang->line('order_total'); ?> :</td>
                            <td width="20%" class="bdr-bottom bdr-right"><?php       if (isset($total))  echo to_currency($total); ?>
                            </td>
                        </tr>

                        <tr class="odd">
                            <td width="80%" align="right" class="bdr-bottom bdr-right text-right" colspan="3"><?php echo $this->lang->line('promocode_discount'); ?> :</td>
                            <td width="20%" class="bdr-bottom bdr-right">
                                -
                                <?php
                                if (isset($total))
                        ...
                        <?php if (isset($total)) if ($customer_order['OrderPolicyId'] == '2') : ?>
                                <tr class="even">
                                    <td width="80%" align="right" class="bdr-bottom bdr-right text-right" colspan="3"><?php echo $this->lang->line('delivery_cost'); ?> :</td>
                                ...
                                <tr class="odd">
                                    <td width="80%" align="right" class="bdr-bottom bdr-right text-right" colspan="3"><?php echo $this->lang->line('subtotal'); ?> :</td>
                                    <td width="20%" class="bdr-bottom bdr-right"><?php if (isset($total)) echo to_currency($total); ?>
                                    </td>
                                </tr>
                        <?php  endif; ?>
                        <tr class="even">
                            <td width="80%" align="right" class="bdr-bottom bdr-right text-right" colspan="3"><?php echo $this->lang->line('vat'); ?> :</td>
                            <td width="20%" class="bdr-bottom bdr-right">+ <?php
                        ...
                        <tr class="odd">
                            <td width="80%" align="right" class="bdr-bottom bdr-right text-right" colspan="3"><?php echo $this->lang->line('handling_fee'); ?> :</td>
                        ...
                        <?php if ($customer_order['PaymentMethod'] != 'cod') : ?>
                            <tr class="even">
                                <td width="80%" align="right" class="bdr-bottom bdr-right text-right" colspan="3"><?php echo $this->lang->line('credit_card_fees'); ?> :</td>
                                <td width="20%" class="bdr-bottom bdr-right">+<?php echo to_currency($customer_order['CCFee']) ?>
                                </td>
                            </tr>
                        <?php endif ?>
                        <tr class="odd">
                            <td width="80%" align="right" class="bdr-bottom bdr-right text-right" colspan="3"><?php echo $this->lang->line('grand_total'); ?> :</td>
