                            ...
                            <tbody>
                                ...
                                <tr class="odd">
                                    ...
                                    <td class="bdr-bottom bdr-right">
                                        <?php echo $customer_info['CustAdd1'] . ' ' . $customer_info ['CustAdd2'] . ', ' . $customer_info ['CustPostcode'] . ', ' . $cities[$customer_info['CustTown']]; ?>
                                    </td>
                                    <?php if ($cust_address): ?>
                                ...
                                <?php if (is_array($cust_address) && !empty($cust_address)): ?>
                                    ...
                                    <?php foreach ($cust_address as $cust_adrs): ?>
                                        <tr class="<?php $count % 2 == 0 ? print'even' : print"odd" ?>">
                                            ...
                                            <td class="bdr-bottom bdr-right">
                                                <?php echo $cust_adrs['CustAdd1'] . ' ' . $cust_adrs ['CustAdd2'] . ', ' . $cust_adrs ['CustPostcode'] . ', ' . $cities[$cust_adrs['CustTown']]; ?>
                                            </td>
                                ...
                                <tbody>
                                    ...
                                    <tr class="odd">
                                        ...
                                        <td class="bdr-bottom" width="60%">
                                            <select name="customers_town" id="customers_town" class="dropdown input1">
                                                <option></option>
                                ...
                                <tr class="odd">
                                    ...
                                    <td width="60%" class="bdr-bottom">
                                        ...
                                        if (!isset($postcode[1]))
                                            $postcode[1] = '';
                                        ?>
                                        <input class="textfield-small"  name="customers_postcode1" style="text-transform: uppercase" type="text" maxlength="4" onkeyup="jQuery(this).val(jQuery(this).val().toUpperCase());" id="customers_postcode1" value="<?Php echo $postcode[0]; ?>" />

                                        <input class="textfield-small" name="customers_postcode2" style="text-transform: uppercase" type="text" maxlength="4" onkeyup="jQuery(this).val(jQuery(this).val().toUpperCase());" id="customers_postcode2" value="<?Php echo $postcode[1]; ?>"/>
                                    </td>
                                </tr>
                                <tr class="even">
