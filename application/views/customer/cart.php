        ...
        <div class="col-md-9">
            <div class="content-innerspan2">
                <div class="innercommon-right">
                    <h1>My Cart</h1>
                    <div style="width:100% !important;" class="account_top">
                        <?php
                        ...
                        <div class="mycart theiaStickySidebar container">
                            <?php
                            $trcolor = '#fef0f0';
                            if (!empty($unique)) {
                                ...
                                <?php if ($grand_total > 0) : ?>
                                    ...
                                    <?php if ($deliverytype == 2) : ?>		
                                        <div class="calculation">
                                            <div class="caltext1 text-right"><?php echo $this->lang->line('online_cart_total') ?> </div>
                                            <div class="caltext2 text-right"><?= to_currency($ftotal) ?></div>
                                        </div>
                                    <?php else: ?>
                                        <div class="calculation">
                                            <div class="caltext1 text-right text-uppercase"><?php echo $this->lang->line('online_cart_total') ?> </div>
                                            <div class="caltext2 text-right"><?= (to_currency($grand_total)) ?></div>
                                        </div>
                                    <?php endif; ?>
                                <?php endif; ?>
                                <div class="checkoutarea">
                                    <div class="btncheckout">
                                        <a href="<?= site_url('orderonline') ?>">Continue Shopping</a>
                                    </div>
                                </div>
                            <?php else: ?>
                                <div class="calculation text-center text-uppercase">
                                    Your cart is empty
                                </div>
                                <div class="checkoutarea">
                                    <div class="btncheckout">
                                        <a href="<?= site_url('orderonline') ?>">Go For Shopping</a>
                                    </div>
                                </div>
                            <?php endif; ?>
                        </div>
