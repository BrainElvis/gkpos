            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <ul class="footer-nav">
                        ...
                        <li><a href="<?php echo base_url() ?>orderonline"><?php echo $this->lang->line('menu_online_order')?></a></li>
                        <li><a href="<?php echo base_url() ?>contact"><?php echo $this->lang->line('menu_contact')?></a></li>
                        <li><a href="<?php echo base_url() ?>pages/index/terms-and-conditions">Terms&Condition</a></li>
                        <li><a href="<?php echo base_url() ?>pages/index/privacy-policy">Privacy Policy</a></li>
                        <li><a href="<?php echo base_url() ?>pages/index/help"><?php echo $this->lang->line('menu_help')?></a></li>
                    </ul>
                </div>
                <!-- .col-md-6 -->
            </div>
