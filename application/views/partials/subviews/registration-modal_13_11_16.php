            ...
            <ul id="form-section1">
                ...
                <li>
                    <label class="single-line">
                        <span><?php echo $this->lang->line('common_phone_number') ?><font class="required">*</font></span>
                        <input type="tel" required="" title="It must contain a valid phone number formed only by numerical values and a length between 7 and 13 characters !" placeholder="Enter your phone number" tabindex="4" pattern="(\+?\d[- .]*){7,13}" id="CustTelephone" name="CustTelephone">
                    </label>
                </li>
                ...
                <li>
                    <label class="single-line">
                        ...
                        <input type="text" required="" title="It must contain only numbers and a length of minimum 3 characters !" placeholder="Enter your Eircode" onkeyup="jQuery(this).val(jQuery(this).val().toUpperCase());" maxlength="9" tabindex="8" id="CustPostcode" name="CustPostcode">
                    </label>
                </li>
                <div style="clear: both;"></div>
