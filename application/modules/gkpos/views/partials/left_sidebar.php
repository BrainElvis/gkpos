<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 left-item">
    <div class="userlogingbg">
        ...
        <a href="<?php echo site_url('gkpos/systemmanagement')?>"><div class="mainsystembg img-responsive"><?php echo $this->lang->line('gkpos_system_management')?></div></a>
        <a href="#"><div class="mainsystembg2 img-responsive"><?php echo $this->lang->line('gkpos_table_information')?></div></a>
        <a href="#"><div class="mainsystembg img-responsive"><?php echo $this->lang->line('gkpos_name_table')?></div></a>
        <a href="#"><div class="mainsystembg2 img-responsive"><?php echo $this->lang->line('gkpos_change_details')?></div></a>
    </div>
</div>