<div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 left-item">
    ...
    <a href="javascript:void(0)" onclick="getSettingPage('<?php echo site_url('gkpos/settings/indexcontent') ?>', 'System Manager')"><div class="mainsystembg delivery-bg img-responsive text-uppercase"><?php echo $this->lang->line('gkpos_home') ?></div></a>
