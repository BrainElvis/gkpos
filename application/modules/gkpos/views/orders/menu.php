<div class="order-menu-list">
    ...
    <div id="menuListArea">
        <?php echo $this->load->view('order_info', array('order_info' => $currentOrderObj, 'first_taken' => !empty($firstTaken) ? $firstTaken[0]->first_taken : '', 'last_taken' => !empty($lastTaken) ? $lastTaken[0]->last_taken : '')) ?>
    </div>
</div>
<script>
