<div class="col-lg-2 col-md-2 col-sm-2 col-xs-12 left-item">
    ...
    <div class="userlogingbg">
        <a href="#"><div class="mainsystembg img-responsive"><?php echo $this->lang->line('gkpos_add').' '.$this->lang->line('gkpos_category') ?></div></a>
        <a href="#"><div class="mainsystembg2 img-responsive"><?php echo $this->lang->line('gkpos_add').' '.$this->lang->line('gkpos_menu')  ?></div></a>
        <a href="#"><div class="mainsystembg img-responsive"><?php echo $this->lang->line('gkpos_add').' '.$this->lang->line('gkpos_menu').' '.$this->lang->line('gkpos_selection') ?></div></a>
        <a href="<?php echo site_url('gkpos')?>"><div class="mainsystembg2 img-responsive"><?php echo $this->lang->line('gkpos_mainboard') ?></div></a>
    </div>
