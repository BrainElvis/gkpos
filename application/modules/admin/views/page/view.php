            ...
            <div class="x_panel">
                ...
                <div class="content">
                    <div class="content bulk_action input">
                        <table class="table table-striped responsive-utilities jambo_table bulk_action">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><img src="<?php isset($image) ? print UPLOAD_PATH . 'page/' . $image : '' ?>"/></td>
                                </tr>
                                <tr>
                        ...
                        <a href="<?php echo site_url('admin/page') ?>" class="btn btn-success"><?php echo $this->lang->line('common_back') ?></a>
                    </div>
                </div>
            </div>
        </div>
