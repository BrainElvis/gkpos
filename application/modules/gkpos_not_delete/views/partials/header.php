    ...
    <nav class="navbar navbar-default navbar-fixed-top top-borderbg">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
                    <div class="text-capitalize text-center user-profile text-vertical-center text-center"><?php echo $admin ?>&nbsp;<span class="glyphicon glyphicon-chevron-right"></span>&nbsp;<span id="userPageHeading"><?php echo $current_section?></span></div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-4">
