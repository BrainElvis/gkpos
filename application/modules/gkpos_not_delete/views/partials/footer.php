...
<div style="display:none">
    <div id="warningPopup" class="popupouter">
        <div class="popup-header row">
            <div id="warningPopupHeader" class="warningPopupHeader col-lg-10 col-md-10 col-sm-10 col-xs-10 pull-left "></div>
            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2 pull-left closeWarningPopup text-center times">&times;</div>
        </div>
        <div class="popup-body row">
            <div id="warningPopupContent" class="warningPopupContent col-lg-12 col-md-12 col-sm-12 col-xs-12"></div>
        </div>
