<a href="javascript:void(0)" class="manage-menu btn btn-block btn-lg btn-danger text-center text-uppercase" onclick="toggleContent('AddCategoryBlock')"><span class="glyphicon glyphicon-plus"></span>&nbsp;<?php echo $this->lang->line('gkpos_add') . ' ' . $this->lang->line('gkpos_menu') . ' ' . $this->lang->line('gkpos_category') ?></a>
<div id="AddCategoryBlock" style="display: none;" class="add-category-block">
    <div class="row content">
        <fieldset>
            <?php $action = $this->uri->segment(4) ? 'gkpos/menumanager/category/' . $this->uri->segment(4) : 'gkpos/menumanager/category' ?>
